...
namespace GameTool.Assistants.Helper
{
    ...
    public class ResizeTexture2D : TextureTools
    {
        ...
        void OnGUI()
        {
            ...
            if (GUILayout.Button("Select All Found Textures"))
            {
                SelectFoundTextures();
            }
            
            if (GUILayout.Button("Select All Textures Compressed Android"))
            {
                SelectAndroidCompressedTextures();
            }
            EditorGUILayout.EndScrollView();
        }

        private void SelectFoundTextures()
        {
            List<Object> objectsToSelect = new List<Object>();

            foreach (var path in listString)
            {
            ...
            Debug.Log($"Selected {objectsToSelect.Count} textures.");
        }

        private void SelectAndroidCompressedTextures()
        {
            List<Object> objectsToSelect = new List<Object>();
            ...
            foreach (var path in listString)
            {
                ...
                {
                    // Check if Android platform override exists
            ...
            Selection.objects = objectsToSelect.ToArray();
            Debug.Log($"Selected {objectsToSelect.Count} Android compressed textures.");
        }
